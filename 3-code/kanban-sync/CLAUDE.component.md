...
**Technology**: TBD per Code-phase decision (Python likely — markdown manipulation + YAML frontmatter). Recorded as a per-component `DEC-*` when the first implementation task is picked up.
